...
async function loadOrderDetails(){
  ...
  if(orderId){
    ...
    const link=document.getElementById('linkMyOrders'); if (link) { link.setAttribute('data-order-id', orderId); link.href = `/shop/my-orders.html?id=${encodeURIComponent(orderId)}`; }
